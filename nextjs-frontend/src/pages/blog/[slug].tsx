...
import { getAllBlogsWithSlug, getBlogAndMoreBlogs } from "src/lib/api";
...
const BlogItemPage: React.FC<PostProps> = ({ blog, moreBlogs, preview }) => {
...
export const getStaticPaths: GetStaticPaths = async () => {
  ...
  return {
    paths: allBlogs?.map((blog) => `/blog/${blog.slug}`) || [],
    fallback: true,
  };
};
